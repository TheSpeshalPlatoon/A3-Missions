...
BIS_CP_enemyGrp_sentry = configFile >> "CfgGroups" >> "East" >> "rhs_faction_vdv" >> "rhs_group_rus_vdv_infantry" >> "rhs_group_rus_vdv_infantry_MANEUVER";
BIS_CP_enemyGrp_fireTeam = configFile >> "CfgGroups" >> "East" >> "rhs_faction_vdv" >> "rhs_group_rus_vdv_infantry" >> "rhs_group_rus_vdv_infantry_squad_mg_sniper";
BIS_CP_enemyGrp_rifleSquad = configFile >> "CfgGroups" >> "East" >> "rhs_faction_vdv" >> "rhs_group_rus_vdv_infantry" >> "rhs_group_rus_vdv_infantry_squad";
BIS_CP_enemyTroops = []; {BIS_CP_enemyTroops pushBack getText (_x >> "vehicle")} forEach ("TRUE" configClasses BIS_CP_enemyGrp_rifleSquad);

BIS_CP_enemyVeh_MRAP = "rhs_tigr_sts_vdv";
BIS_CP_enemyVeh_Truck = configFile >> "CfgGroups" >> "East" >> "rhs_faction_vdv" >> "rhs_group_rus_vdv_gaz66" >> "rhs_group_rus_vdv_gaz66_squad";
BIS_CP_enemyVeh_UAV_big = "rhs_bmd2";
BIS_CP_enemyVeh_UAV_small = "rhsgref_BRDM2_vdv";

BIS_CP_enemyVeh_reinf1 = "rhsgref_BRDM2_vdv";
BIS_CP_enemyVeh_reinf2 = "rhs_btr80a_vdv";
BIS_CP_enemyVeh_reinfAir = "RHS_Mi8mt_vdv";

BIS_CP_supportClasses = ["RHS_Ural_Ammo_VDV_01", "RHS_Ural_Fuel_VDV_01", "RHS_Ural_Repair_VDV_01"];

BIS_CP_HVT = "rhs_vdv_officer_armored";
BIS_CP_Guard = "rhs_vdv_rifleman";
...
sleep 1;
if (isServer) then {arsenal setPos (getPos (playableUnits#0))};
