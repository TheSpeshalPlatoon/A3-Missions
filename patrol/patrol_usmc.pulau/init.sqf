...
BIS_CP_enemySide = RESISTANCE;
BIS_CP_enemySideTrigger = "RESISTANCE D";
BIS_CP_distance = 2000;

BIS_CP_enemyGrp_sentry = configFile >> "CfgGroups" >> "Indep" >> "IND_C_F" >> "Infantry" >> "BanditFireTeam";
BIS_CP_enemyGrp_fireTeam = configFile >> "CfgGroups" >> "Indep" >> "IND_C_F" >> "Infantry" >> "ParaFireTeam";
BIS_CP_enemyGrp_rifleSquad = configFile >> "CfgGroups" >> "Indep" >> "IND_C_F" >> "Infantry" >> "BanditCombatGroup";
BIS_CP_enemyTroops = []; {BIS_CP_enemyTroops pushBack getText (_x >> "vehicle")} forEach ("TRUE" configClasses BIS_CP_enemyGrp_rifleSquad);

BIS_CP_enemyVeh_MRAP = "I_C_Offroad_02_LMG_F";
BIS_CP_enemyVeh_Truck = configFile >> "CfgGroups" >> "Indep" >> "IND_C_F" >> "Infantry" >> "ParaCombatGroup";
BIS_CP_enemyVeh_UAV_big = "rhsgref_tla_g_offroad_armed";
BIS_CP_enemyVeh_UAV_small = "I_C_Offroad_02_AT_F";

BIS_CP_enemyVeh_reinf1 = "rhsgref_tla_g_btr60";
BIS_CP_enemyVeh_reinf2 = "rhsgref_tla_g_btr60";
BIS_CP_enemyVeh_reinfAir = "rhsgref_tla_g_btr60";

BIS_CP_supportClasses = ["C_Van_01_box_F", "C_Truck_02_fuel_F", "C_Truck_02_box_F"];

BIS_CP_HVT = "I_C_Soldier_Camo_F";
BIS_CP_Guard = "I_C_Soldier_Para_7_F";
