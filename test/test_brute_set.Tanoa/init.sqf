...
tsp_fnc_butter = {
	...
	while {sleep (1 / (diag_fps * 20)); !isNil "butter_camera"} do {
		...
		//-- MOUSE
			...
			{_x setDir (butter_yaw_chaser)} forEach [butter_camera];
...
[] spawn tsp_fnc_butter;
[] spawn {sleep 0.5; butter_speed_modifier = 0.2; butter_fov_actual = 0.14; {_x setDir 285.961} forEach [butter_tripod, butter_camera];};
[] spawn { 
    {_x disableAI "MOVE"; _x disableAI "ANIM"} forEach [l1,l2,l3,l4,l5,l6,r1,r2,r3,r4,r5,r6,guy]; 
	waitUntil {butter_camera distance2d guy < 35};
    guy switchMove "brute_hammer_walk"; 
    sleep 5; 
    [guy, ["brute_hammer_idle", 0, 0, false]] remoteExec ["switchMove"]; 
    sleep 1; 
    l1 switchMove "brute_pistol_sprintf"; 
    l2 switchMove "brute_one_sprintf"; 
    l3 switchMove "brute_rifle_sprintf"; 
    l4 switchMove "brute_pistol_sprintf"; 6
    l5 switchMove "brute_pistol_sprintf"; 
    l6 switchMove "brute_pistol_sprintf"; 
    r1 switchMove "brute_rifle_sprintf"; 
    r2 switchMove "brute_rifle_sprintf"; 
    r3 switchMove "brute_rifle_sprintf"; 
    r4 switchMove "brute_one_sprintf"; 
    r5 switchMove "brute_rifle_sprintf"; 
    r6 switchMove "brute_one_sprintf"; 
    sleep 0.5; 
    guy setFace "comp21_brute_torgar_open"; 
}