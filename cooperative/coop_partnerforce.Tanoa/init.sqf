...
[
	...
	{
		count ([task_civ1,task_civ2,task_civ3,task_civ4,task_civ5,task_civ6,task_civ7] select {_x distance lpd < 100}) > 0 && 
		count ([task_civ1,task_civ2,task_civ3,task_civ4,task_civ5,task_civ6,task_civ7] select {_x distance lpd < 100 || !alive _x}) == 7
	}, 
...
[
	...
	"Kill", objNull, {true}, {task_solomon distance lpd < 100 || !alive task_solomon}, {false}
] spawn tsp_fnc_task;
[
