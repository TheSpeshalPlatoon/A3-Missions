...
[
	...
	"Attack", "sector_ixel", {true}, {["ixel", "", sector_ixel, 50, 0, [west]] call tsp_fnc_sector_clear}
] spawn tsp_fnc_task;
[
	east, "masbete", "Secure Masbete", "RACS forces have occupied Masbete, secure it.", 
	"Attack", "sector_masbete", {true}, {["masbete", "", sector_masbete, 0, 3, [west]] call tsp_fnc_sector_clear}
] spawn tsp_fnc_task;
[
