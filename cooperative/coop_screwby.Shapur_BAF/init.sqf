...
[
	...
	"Attack", getPos task_shapur1, {true}, {"shapur1" call tsp_fnc_sector_check && (count (allUnits select {_x inArea trigger_shapur1 && side _x == resistance}) < 2)}
] spawn tsp_fnc_task;
...
[
	...
	"Attack", getPos task_shapur2, {true}, {"shapur2" call tsp_fnc_sector_check && (count (allUnits select {_x inArea trigger_shapur2 && side _x == resistance}) < 2)}
] spawn tsp_fnc_task;
...
[
	...
	"Attack", getPos task_mb, {true}, {"mb" call tsp_fnc_sector_check && (count (allUnits select {_x inArea trigger_mb && side _x == resistance}) < 2)}
] spawn tsp_fnc_task;
...
[
	...
	"Attack", getPos task_airfield, {true}, {"airfield" call tsp_fnc_sector_check && (count (allUnits select {_x inArea trigger_airfield && side _x == resistance}) < 2)}
] spawn tsp_fnc_task;
...
[
	...
	"Attack", getPos task_oli, {true}, {"oli" call tsp_fnc_sector_check && (count (allUnits select {_x inArea trigger_oli && side _x == resistance}) < 2)}
] spawn tsp_fnc_task;