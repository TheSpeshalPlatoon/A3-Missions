...
[
    ...
    "Move", "sector_civtown", {true}, {false}, {false}, {count (playableUnits select {_x distance sector_civtown < 50}) > 0}
] spawn tsp_fnc_task;
[
	west, ["westminster", "primary"], "Advance to Westminster", "Advance And Report if <marker name='marker_16'>Westminster</marker> is secure.", 
	"Move", "sector_gasstation", {true},  {["gasstation", "", sector_gasstation, 50, 0] call tsp_fnc_sector_clear}
] spawn tsp_fnc_task;
[
	west, ["alderney", "primary"], "Advance to Alderney", "Advance And Report if <marker name='marker_12'>Alderney</marker> is secure.", 
	"Move", "sector_mansion_in", {true}, {["mansion_in", "", sector_mansion_in, 0, 0] call tsp_fnc_sector_clear}
] spawn tsp_fnc_task;
[
	west, ["schottler", "primary"], "Secure Schottler", "Advance And Secure <marker name='marker_14'>Schottler</marker>.", 
	"Attack", "sector_jumo", {true}, {["jumo", "", sector_jumo, 0, 0] call tsp_fnc_sector_clear}
] spawn tsp_fnc_task;
[
	west, ["schottler_defend", "primary"], "Defend Schottler", "Enemy reinforcements have been spotted, hold Schottler!", "Defend", "sector_jumo", 
	{"schottler" call BIS_fnc_taskState == "SUCCEEDED"},{!isNil "task_schott_bool" && ["jumo", "", sector_jumo, 0, 2] call tsp_fnc_sector_clear}, {false}, {false}, 
...
[
	...
	"Attack", "sector_staging", {true}, {["staging", "", sector_staging, 100, 2] call tsp_fnc_sector_clear}
] spawn tsp_fnc_task;
[
	...
	"Scout", objNull, {true}, {count (playableUnits select {_x distance sector_crashsite_units < 100}) > 0}
] spawn tsp_fnc_task;
[
	west, ["crashsite_defend", "secondary"], "Defend Crashsite", "Enemy reinforcements have been spotted, hold the crashsite!", "Defend", "sector_crashsite_units", 
	{"crashsite" call BIS_fnc_taskState == "SUCCEEDED"},{!isNil "task_crash_bool" && ["crashsite_units", "", sector_crashsite_units, 0, 2] call tsp_fnc_sector_clear}, {false}, {false}, 
