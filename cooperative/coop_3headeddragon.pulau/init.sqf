//-- Quick copy: tsp_totalIntel = 99; tsp_totalMoney = 99; tsp_chanceIntel = 0.5; tsp_chanceTalk = 0.5; 
...
[west, ["camp2", "side"], localize "STR_TASK_CAMP_TITLE", localize "STR_TASK_CAMP_DESC", "Attack", "sector_camp2", {tsp_totalIntel >= 4}, {["camp2", "", sector_camp2, 100] call tsp_fnc_sector_clear}] spawn tsp_fnc_task;
[west, ["camp3", "side"], localize "STR_TASK_CAMP_TITLE", localize "STR_TASK_CAMP_DESC", "Attack", "sector_camp3", {tsp_totalIntel >= 6}, {["camp3", "", sector_camp3, 100] call tsp_fnc_sector_clear}] spawn tsp_fnc_task;
[west, ["camp1", "side"], localize "STR_TASK_CAMP_TITLE", localize "STR_TASK_CAMP_DESC", "Attack", "sector_camp1", {tsp_totalIntel >= 10}, {["camp1", "", sector_camp1, 100] call tsp_fnc_sector_clear}] spawn tsp_fnc_task;
...
[west, ["camp5", "side"], localize "STR_TASK_CAMP_TITLE", localize "STR_TASK_CAMP_DESC", "Attack", "sector_camp5", {tsp_totalIntel >= 24}, {["camp5", "", sector_camp5, 100] call tsp_fnc_sector_clear}] spawn tsp_fnc_task;
...
[west, ["camp4", "side"], localize "STR_TASK_CAMP_TITLE", localize "STR_TASK_CAMP_DESC", "Attack", "sector_camp4", {tsp_totalIntel >= 30}, {["camp4", "", sector_camp4, 100] call tsp_fnc_sector_clear}] spawn tsp_fnc_task;
...
[west, ["camp6", "side"], localize "STR_TASK_CAMP_TITLE", localize "STR_TASK_CAMP_DESC", "Attack", "sector_camp6", {tsp_totalIntel >= 35}, {["camp6", "", sector_camp6, 100] call tsp_fnc_sector_clear}] spawn tsp_fnc_task;
