tsp_fnc_killhouse = {
	...
	{[_x, 'Door01'] call BIS_fnc_DoorNoHandleClose} forEach ((_start nearObjects [_outerDoorType, 5]) + (_end nearObjects [_outerDoorType, 5]));  //-- Close outer doors
    ...
    _usedTypes = [];
    {
        [_x] params ["_helper"]; _usedTypes pushBack typeOf _helper;
    ...
    } forEach (_helpers select {!(typeOf _x in _usedTypes) || typeOf _x == _deadType});
    ...
    {  //-- For For each cell
        ...
        {  //-- For each class, see if appropriate
            _x params ["_class", "_max", "_radius", "_rotate", "_offset", "_offsetVert", "_wall", "_open", "_corner", "_cornerDir"];
            ...
            if ((_wall && count _nearestWalls > 0 && count _nearestWalls == 1) || (_corner && count _nearestHelpers == 4) || (_open && count _nearestWalls == 0)) then {
                ...
                _item setPos [(getPos _item)#0,(getPos _item)#1, _offsetVert]; _item enableSimulation false; _item setDir (getDir _start);                
    ...
    {_x enableSimulation true} forEach _furniture; 
...
tsp_fnc_lights = {  //-- Toggle lights on/off
	...
	tsp_fnc_lights_wait = true;
	{
		...
		playSound3D [getMissionPath (if (damage _x > 0.1) then {"off.ogg"} else {"on.ogg"}), _x, false, getPosASL _x, 5, random 2 max 0.5 min 2, _distance];
...
furniture_altis = [
    ["Land_ArmChair_01_F",2,2,0,-0.1,0,false,false,true,true],  //-- Class, max, radius, rotation, offset, vertical, wall, open, corner, cornerDir

    ["Land_ShelvesWooden_F",2,2,90,-0.6,0,true,false,true,false], 
    ["OfficeTable_01_old_F",1,2,0,-0.5,0,true,false,false,false],
    ["Land_Bench_F",1,2,90,-0.6,0,true,false,false,false], 
    ["Land_OfficeCabinet_02_F",2,2,0,-0.6,0,true,false,true,false], 
    ["Land_Metal_rack_Tall_F",2,2,0,-0.5,0,true,false,true,false], 
    ["Land_Metal_wooden_rack_F",1,2,0,-0.5,0,true,false,true,false], 
    ["Land_Rack_F",2,3,90,-0.6,0,true,false,true,false], 
    ["Land_Sofa_01_F",1,4,180,-0.2,0,true,false,false,false], 
    ["Land_WoodenBed_01_F",1,4,0,0.5,0,true,false,false,false], 

    ["Land_WoodenTable_large_F",1,3,0,0,0,false,true,false,false],
    ["Land_WoodenTable_small_F",1,3,0,0,0,false,true,false,false],
    ["Land_Rug_01_F",1,4,0,0,0,false,true,false,false],
    ["Land_Rug_01_Traditional_F",1,4,0,0,0,false,true,false,false],
    ["Land_CratesWooden_F",2,2,0,0,0,true,true,false,false]
];
furniture_tanoa = [
    ["Land_RattanChair_01_F",2,2,180,0.1,0,false,false,true,true],  //-- Class, max, radius, rotation, offset, vertical, wall, open, corner, cornerDir
    ["Land_ChairPlastic_F",2,2,-90,0.1,0,false,false,true,true],

    ["Land_ShelvesWooden_F",2,2,90,-0.6,0,true,false,true,false], 
    ["Land_WoodenCounter_01_F",1,2,0,-0.4,0,true,false,false,false],
    ["Land_OfficeCabinet_02_F",2,2,0,-0.6,0,true,false,true,false],
    ["Land_Metal_rack_Tall_F",2,2,0,-0.5,0,true,false,true,false], 
    ["Land_Metal_wooden_rack_F",1,2,0,-0.5,0,true,false,true,false], 
    ["Land_Rack_F",2,3,90,-0.6,0,true,false,true,false], 
    ["\A3\structures_f_enoch\furniture\Chairs\vojenska_palanda\vojenska_palanda.p3d",1,4,0,0,-0.22,true,false,false,false], 

    ["Land_RattanTable_01_F",1,4,0,0,0,false,true,false,false],
    ["Land_TablePlastic_01_F",1,4,0,0,0,false,true,false,false],
    ["Land_WoodenTable_large_F",1,4,0,0,0,false,true,false,false],
    ["Land_WoodenTable_small_F",1,4,0,0,0,false,true,false,false],
    ["Land_Garbage_square3_F",1,2,0,0,0,false,true,false,false],
    ["Land_Garbage_square5_F",1,2,0,0,0,false,true,false,false],
    ["Land_WoodenCrate_01_F",1,2,90,-0.5,0,true,false,false,false],
    ["Land_WoodenCrate_01_stack_x3_F",1,2,90,0,0,false,true,true,false],
    ["Land_WoodenCrate_01_stack_x5_F",1,2,0,0,0,false,true,true,false]
];
furniture_livonia = [
    ["Land_ArmChair_01_F",2,2,0,-0.1,0,false,false,true,true],  //-- Class, max, radius, rotation, offset, vertical, wall, open, corner, cornerDir
    ["a3\structures_f_enoch\furniture\cases\locker\locker_closed_v1.p3d",1,2,0,-0.65,0,true,false,true,false],
    ["a3\structures_f_enoch\furniture\cases\locker\locker_open_v1.p3d",1,2,0,-0.65,0,true,false,true,false],

    ["Land_Sofa_01_F",1,4,180,-0.2,0,true,false,false,false], 
    ["a3\structures_f_enoch\furniture\cases\library_a\library_a.p3d",1,3,180,-0.7,0,true,false,true,false], 
    ["a3\structures_f_enoch\furniture\cases\library_a\library_a_open.p3d",1,3,180,-0.7,0,true,false,true,false], 
    ["a3\structures_f_enoch\furniture\school_equipment\class_case_b_closed.p3d",1,3,0,-0.4,0,true,false,true,false], 
    ["a3\structures_f_enoch\furniture\school_equipment\class_case_b_open.p3d",1,3,0,-0.4,0,true,false,true,false], 
    ["a3\structures_f_enoch\furniture\school_equipment\class_case_a_closed.p3d",1,3,0,-0.5,0,true,false,true,false], 
    ["a3\structures_f_enoch\furniture\school_equipment\class_case_a_open.p3d",1,3,0,-0.5,0,true,false,true,false], 
    ["a3\structures_f_enoch\furniture\cases\dhangar_borwnskrin\dhangar_brownskrin.p3d",1,3,0,-0.5,0,true,false,true,false], 
    ["a3\structures_f_enoch\furniture\cases\dhangar_borwnskrin\dhangar_brownskrin_open.p3d",1,3,0,-0.5,0,true,false,true,false], 
    ["a3\structures_f_enoch\furniture\beds\postel_panelak1.p3d",1,3,0,0.18,0,true,false,false,false], 
    ["a3\structures_f_enoch\furniture\beds\postel_panelak2.p3d",1,3,0,0.18,-0.1,true,false,false,false], 

    ["a3\structures_f_enoch\furniture\decoration\piano\piano.p3d",1,4,0,0,0.9,false,true,false,false],
    ["a3\structures_f_enoch\furniture\various\carpet_2_dz.p3d",1,2,0,0,0.2,false,true,false,false],
    ["Land_TableBig_01_F",1,3,0,0,0,false,true,false,false],
    ["Land_WoodenCrate_01_F",1,2,90,-0.5,0,true,false,false,false],
    ["Land_WoodenCrate_01_stack_x3_F",1,2,90,0,0,false,true,true,false],
    ["Land_WoodenCrate_01_stack_x5_F",1,2,0,0,0,false,true,true,false]
];

if (time < 1) exitWith {};  //-- Notes below

[[
    kh1_start, kh1_end, kh1_area, 6, 10, 5, 0,          
    ["Bro_MSW_2m"], "Bro_MSW_2m_conc", 2,  
    ["Bro_MSW_2m_d", "Bro_MSW_2m_d", "Bro_MSW_2m_de"], "Bro_MSW_2m_d_conc", 0.2, 0.95, 0.5,   
    10, 20, 0.05,  
    0, east, [],  
    0, [],  
    0.25, ["Target_F"],
    0.5, furniture_livonia
], tsp_fnc_killhouse] remoteExec ["spawn", 2];

[  
    this, "Generate Killhouse (Altis, Live)", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_forceRespawn_ca.paa",   
    {[[  
        kh1_start, kh1_end, kh1_area, 6, 10, 5, 0,          
        ["Bro_MSW_2m"], "Bro_MSW_2m_conc", 2,  
        ["Bro_MSW_2m_d", "Bro_MSW_2m_d", "Bro_MSW_2m_de"], "Bro_MSW_2m_d_conc", 0.2, 0.95, 0.5,   
        10, 20, 0.05, 0.7, east, enemy_altis, 0.05, civ_altis, 0, ["Target_F"], 0.5, furniture_altis
    ], tsp_fnc_killhouse] remoteExec ["spawn", 2]}, "!(kh1_start getVariable ['generating', false])", false, 1, [], -100  
] call tsp_fnc_action_hold;
[  
    this, "Generate Killhouse (Altis, Targets)", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_forceRespawn_ca.paa",   
    {[[  
        kh1_start, kh1_end, kh1_area, 6, 10, 5, 0,          
        ["Bro_MSW_2m"], "Bro_MSW_2m_conc", 2,  
        ["Bro_MSW_2m_d", "Bro_MSW_2m_d", "Bro_MSW_2m_de"], "Bro_MSW_2m_d_conc", 0.2, 0.95, 0.5,   
        10, 20, 0.05, 0, resistance, enemy_altis, 0, civ_altis, 0.25, ["Target_F"], 0.5, furniture_altis
    ], tsp_fnc_killhouse] remoteExec ["spawn", 2]}, "!(kh1_start getVariable ['generating', false])", false, 1, [], -100 
] call tsp_fnc_action_hold; 
[  
    this, "Generate Killhouse (Tanoa, Live)", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_forceRespawn_ca.paa",   
    {[[  
        kh1_start, kh1_end, kh1_area, 6, 10, 5, 0,          
        ["Bro_MSW_2m"], "Bro_MSW_2m_conc", 2,  
        ["Bro_MSW_2m_d", "Bro_MSW_2m_d", "Bro_MSW_2m_de"], "Bro_MSW_2m_d_conc", 0.2, 0.95, 0.5,   
        10, 20, 0.05, 0.7, resistance, enemy_tanoa, 0.05, civ_tanoa, 0, ["Target_F"], 0.5, furniture_tanoa
    ], tsp_fnc_killhouse] remoteExec ["spawn", 2]}, "!(kh1_start getVariable ['generating', false])", false, 1, [], -100  
] call tsp_fnc_action_hold;
[  
    this, "Generate Killhouse (Tanoa, Targets)", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_forceRespawn_ca.paa",   
    {[[  
        kh1_start, kh1_end, kh1_area, 6, 10, 5, 0,          
        ["Bro_MSW_2m"], "Bro_MSW_2m_conc", 2,  
        ["Bro_MSW_2m_d", "Bro_MSW_2m_d", "Bro_MSW_2m_de"], "Bro_MSW_2m_d_conc", 0.2, 0.95, 0.5,   
        10, 20, 0.05, 0, resistance, enemy_tanoa, 0, civ_tanoa, 0.25, ["Target_F"], 0.5, furniture_tanoa
    ], tsp_fnc_killhouse] remoteExec ["spawn", 2]}, "!(kh1_start getVariable ['generating', false])", false, 1, [], -100 
] call tsp_fnc_action_hold; 
[  
    this, "Generate Killhouse (Livonia, Live)", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_forceRespawn_ca.paa",   
    {[[  
        kh1_start, kh1_end, kh1_area, 6, 10, 5, 0,          
        ["Bro_MSW_2m"], "Bro_MSW_2m_conc", 2,  
        ["Bro_MSW_2m_d", "Bro_MSW_2m_d", "Bro_MSW_2m_de"], "Bro_MSW_2m_d_conc", 0.2, 0.95, 0.5,   
        10, 20, 0.05, 0.7, resistance, enemy_livonia, 0.05, civ_livonia, 0, ["Target_F"], 0.5, furniture_livonia
    ], tsp_fnc_killhouse] remoteExec ["spawn", 2]}, "!(kh1_start getVariable ['generating', false])", false, 1, [], -100  
] call tsp_fnc_action_hold;
[  
    this, "Generate Killhouse (Livonia, Targets)", "\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_forceRespawn_ca.paa",   
    {[[  
        kh1_start, kh1_end, kh1_area, 6, 10, 5, 0,          
        ["Bro_MSW_2m"], "Bro_MSW_2m_conc", 2,  
        ["Bro_MSW_2m_d", "Bro_MSW_2m_d", "Bro_MSW_2m_de"], "Bro_MSW_2m_d_conc", 0.2, 0.95, 0.5,   
        10, 20, 0.05, 0, resistance, enemy_livonia, 0, civ_livonia, 0.25, ["Target_F"], 0.5, furniture_livonia
    ], tsp_fnc_killhouse] remoteExec ["spawn", 2]}, "!(kh1_start getVariable ['generating', false])", false, 1, [], -100 
] call tsp_fnc_action_hold; 