...
BIS_CP_enemyGrp_sentry = configFile >> "CfgGroups" >> "East" >> "o_tsp_afr" >> "Infantry" >> "o_tsp_afr_sentry";
BIS_CP_enemyGrp_fireTeam = configFile >> "CfgGroups" >> "East" >> "o_tsp_afr" >> "Infantry" >> "o_tsp_afr_team";
BIS_CP_enemyGrp_rifleSquad = configFile >> "CfgGroups" >> "East" >> "o_tsp_afr" >> "Infantry" >> "o_tsp_afr_squad";
...
BIS_CP_enemyVeh_Truck = configFile >> "CfgGroups" >> "East" >> "o_tsp_afr" >> "Infantry" >> "o_tsp_afr_atteam";
...
BIS_CP_HVT = "tsp_afr_para_warlord";
BIS_CP_Guard = "tsp_afr_para_fal";
