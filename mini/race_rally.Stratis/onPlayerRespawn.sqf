...
[] spawn {
	...
	waitUntil {!isNil "race_zones"}; [player, race_zones, "You are off the track!", {(vehicle _this) setDamage 1; _this setDamage 1}, {alive _this}, 10, 5] spawn tsp_fnc_zone;  //-- Zones
